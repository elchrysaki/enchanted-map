...
# OffMap moderator review for issue #82
...
- **Issue:** [[Discovery]: Human-aligned AI Summer School](https://github.com/elchrysaki/offmap-hub/issues/82)
- **Submitted by:** `elchrysaki`
- **Processed at:** `2026-07-20T12:23:37.149178+00:00`
...
| Recovery template | `not created` | normal generated page or no recoverable intake |
...
- `artifacts/raw-submission-82.json`
- `artifacts/researched-submission-82.json`
- `artifacts/publishable-content-82.json`
- `artifacts/review-report-82.md`
- `opportunities/events/human-aligned-ai-summer-school.md`
...
# 🧭 Moderator Review: Human-aligned AI Summer School
...
| Field | Value |
|---|---|
| Opportunity | Human-aligned AI Summer School |
...
| Original issue | [Open submission](<https://github.com/elchrysaki/offmap-hub/issues/82>) |
| Proposed opportunity page | `opportunities/events/human-aligned-ai-summer-school.md` |
...
- host\_city
- host\_country
- category (confirmed with clarification)
...
- Check for application/registration details and deadlines.
- Clarify if scholarships, travel support, or accommodation are available.
- Confirm if there are any nationality, residency, or academic level restrictions.
- Determine if there is a specific audience focus (e.g., students, early-career researchers).

## 🚫 Claims Excluded From the Public Draft

- No claims about funding, fees, scholarships, or travel support due to lack of evidence.
- No claims about academic level or nationality eligibility due to lack of evidence.
- No claims about audience groups due to lack of evidence.
...
- [Source](<https://humanaligned.ai/2026/>)
- [Source](<https://humanaligned.ai>)
...
Generated at 2026-07-20T12:23:35.335947+00:00.