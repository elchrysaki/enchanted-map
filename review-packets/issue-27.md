...
# OffMap moderator review for issue #27
...
- **Issue:** [[Discovery]:](https://github.com/elchrysaki/offmap-hub/issues/27)
- **Submitted by:** `elchrysaki`
- **Processed at:** `2026-07-19T20:30:18.128913+00:00`
...
- `artifacts/raw-submission-27.json`
- `artifacts/researched-submission-27.json`
- `artifacts/publishable-content-27.json`
- `artifacts/review-report-27.md`
- `opportunities/courses/mission-concept-academy-mca.md`
...
# 🧭 Moderator Review: Mission Concept Academy (MCA)
...
| Field | Value |
|---|---|
| Opportunity | Mission Concept Academy (MCA) |
| Main category | `courses` |
| Specific category | `academy` |
...
| Original issue | [Open submission](<https://github.com/elchrysaki/offmap-hub/issues/27>) |
| Proposed opportunity page | `opportunities/courses/mission-concept-academy-mca.md` |
...
- format
- host\_country
- nationality\_or\_residency\_rules
- academic\_levels
- application\_fee
- participation\_fee
- main\_category (confirmed with clarification)
- category (confirmed with clarification)
- host\_country (confirmed with clarification)
- nationality\_or\_residency\_rules (confirmed with clarification)
- language\_requirements (confirmed with clarification)
- scholarship (confirmed with clarification)
- travel\_support (confirmed with clarification)
- accommodation (confirmed with clarification)
- meals (confirmed with clarification)
- stipend\_or\_salary (confirmed with clarification)
...
- Confirm if non-US students are eligible
- Check for any additional eligibility or selection criteria
- Locate direct application link if available
...
- [Source](<https://www.lspace.asu.edu>)
- [Source](<https://www.lspace.asu.edu/mission-concept-academy>)
...
Generated at 2026-07-19T20:30:16.799147+00:00.