...
# OffMap moderator review for issue #33
...
- **Issue:** [[Discovery]: Lucy Mission Asteroid Ambassador Program](https://github.com/elchrysaki/offmap-hub/issues/33)
- **Submitted by:** `elchrysaki`
- **Processed at:** `2026-07-20T07:16:33.123547+00:00`
...
- `artifacts/raw-submission-33.json`
- `artifacts/researched-submission-33.json`
- `artifacts/publishable-content-33.json`
- `artifacts/review-report-33.md`
- `opportunities/volunteering/lucy-mission-asteroid-ambassador-program.md`
...
# 🧭 Moderator Review: Lucy Mission Asteroid Ambassador Program
...
| Field | Value |
|---|---|
| Opportunity | Lucy Mission Asteroid Ambassador Program |
| Main category | `volunteering` |
| Specific category | `volunteering-program` |
...
| Original issue | [Open submission](<https://github.com/elchrysaki/offmap-hub/issues/33>) |
| Proposed opportunity page | `opportunities/volunteering/lucy-mission-asteroid-ambassador-program.md` |
...
- main\_category: submitted as 'Fellowships', but official evidence suggests 'events' or 'volunteering-program'
- category: submitted as 'Internships — Apprenticeship', but official evidence suggests 'volunteering-program'
- The researched specific category 'volunteering-program' belongs under 'volunteering', not 'events'. OffMap normalized the researched pair together while preserving the contributor's original values under raw.
- Main category: submitted as 'Fellowships', but official evidence suggests 'volunteering'.
- Category: submitted as 'Internships — Apprenticeship', but official evidence suggests 'volunteering-program'.

## 🧩 Important Information Not Found

- application\_page
- application\_deadline (exact date)
- location format (unclear)
- eligibility details
- funding details
- No direct application page found.
- Exact application deadline date not found.
- Location format unclear.
- Eligibility details not found.
- Funding details not found.

## 🔍 Requires Human Judgment

- audience classification (no dropdown group selected, unclear target group)
- location format (in-person vs. remote outreach)
- Clarify opportunity type: fellowship, internship, or volunteering/outreach
- Clarify eligibility and audience
- Clarify format (in-person, remote, hybrid)
...
- [Source](<https://www.lspace.asu.edu/lucy-ambassador-program>)
- [Source](<https://www.lspace.asu.edu/our-programs>)
...
Generated at 2026-07-20T07:16:31.072433+00:00.