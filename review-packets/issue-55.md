...
# OffMap moderator review for issue #55
...
- **Issue:** [[Discovery]: EA Summit: Wellington](https://github.com/elchrysaki/offmap-hub/issues/55)
- **Submitted by:** `elchrysaki`
- **Processed at:** `2026-07-20T08:56:35.320725+00:00`
...
- `artifacts/raw-submission-55.json`
- `artifacts/researched-submission-55.json`
- `artifacts/publishable-content-55.json`
- `artifacts/review-report-55.md`
- `opportunities/events/ea-summit-wellington.md`
...
# 🧭 Moderator Review: EA Summit: Wellington
...
| Field | Value |
|---|---|
| Opportunity | EA Summit: Wellington |
...
| Original issue | [Open submission](<https://github.com/elchrysaki/offmap-hub/issues/55>) |
| Proposed opportunity page | `opportunities/events/ea-summit-wellington.md` |
...
- Check if an application fee, participation fee, or travel support is available.
- Confirm if there is a direct application link or process.
...
- [Source](<https://www.effectivealtruism.org/ea-global/events/ea-summit-wellington?utm_source=ea-opps>)
- [Source](<https://www.effectivealtruism.org/ea-global/events>)
...
Generated at 2026-07-20T08:56:33.492230+00:00.