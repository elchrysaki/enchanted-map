...
# OffMap moderator review for issue #43
...
- **Issue:** [[Discovery]: PauseCon London 2026](https://github.com/elchrysaki/offmap-hub/issues/43)
- **Submitted by:** `elchrysaki`
- **Processed at:** `2026-07-20T08:32:14.856074+00:00`
...
- `artifacts/raw-submission-43.json`
- `artifacts/researched-submission-43.json`
- `artifacts/publishable-content-43.json`
- `artifacts/review-report-43.md`
- `opportunities/events/pausecon-london-2026.md`
...
# 🧭 Moderator Review: PauseCon London 2026
...
| Field | Value |
|---|---|
| Opportunity | PauseCon London 2026 |
...
| Original issue | [Open submission](<https://github.com/elchrysaki/offmap-hub/issues/43>) |
| Proposed opportunity page | `opportunities/events/pausecon-london-2026.md` |
...
- application\_page (confirmed with clarification)
- application\_deadline (confirmed with clarification)
- location.host\_city (confirmed with clarification)
- location.host\_country (confirmed with clarification)
...
- audience
- eligibility
- Exact event start and end dates
...
- Check for any funding or fee information on the event page.
- Clarify eligibility and audience if more information becomes available.
- Confirm exact event dates if possible.
...
- [Source](<https://luma.com/4be2eqz9?utm_source=ea-opps>)
...
Generated at 2026-07-20T08:32:13.054456+00:00.