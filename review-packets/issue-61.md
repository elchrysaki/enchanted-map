...
# OffMap moderator review for issue #61
...
- **Issue:** [[Discovery]: Secure & Sovereign AI Workshop](https://github.com/elchrysaki/offmap-hub/issues/61)
- **Submitted by:** `elchrysaki`
- **Processed at:** `2026-07-20T09:03:37.968810+00:00`
...
- `artifacts/raw-submission-61.json`
- `artifacts/researched-submission-61.json`
- `artifacts/publishable-content-61.json`
- `artifacts/review-report-61.md`
- `opportunities/events/secure-sovereign-ai-workshop.md`
...
# 🧭 Moderator Review: Secure &amp; Sovereign AI Workshop
...
| Field | Value |
|---|---|
| Opportunity | Secure &amp; Sovereign AI Workshop |
| Main category | `events` |
| Specific category | `workshop-seminar` |
...
| Original issue | [Open submission](<https://github.com/elchrysaki/offmap-hub/issues/61>) |
| Proposed opportunity page | `opportunities/events/secure-sovereign-ai-workshop.md` |
...
- identity.opportunity\_name
- identity.main\_category
- identity.current\_edition
- links.official\_page
- dates.start\_date
- dates.end\_date
- location.format
- location.host\_city
- location.host\_country

## ⚠️ Possible Conflicts

- identity.organizer: Contributor listed 'Secure &amp; Sovereign AI Workshop', but official evidence shows 'Foresight Institute' is the organizer.
- identity.category: Contributor listed 'Events — Conference', but official evidence shows this is a 'workshop-seminar'.
...
- audience.groups: No dropdown audience group selected; official evidence does not clarify eligible communities.
- Check for application instructions or eligibility details if available elsewhere.
- Clarify if there are any fees or funding options for participants.
- Confirm if there are any audience restrictions or priorities.
...
- [Source](<https://foresight.org/events/2026-secure-sovereign-ai-workshop/?utm_source=ea-opps>)
- [Source](<https://foresight.org/events/2026-secure-sovereign-ai-workshop>)
- [Source](<https://foresight.org>)
...
Generated at 2026-07-20T09:03:36.520433+00:00.