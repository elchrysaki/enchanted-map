...
# OffMap moderator review for issue #65
...
- **Issue:** [[Discovery]: EAGxIndia 2026](https://github.com/elchrysaki/offmap-hub/issues/65)
- **Submitted by:** `elchrysaki`
- **Processed at:** `2026-07-20T09:05:34.616393+00:00`
...
- `artifacts/raw-submission-65.json`
- `artifacts/researched-submission-65.json`
- `artifacts/publishable-content-65.json`
- `artifacts/review-report-65.md`
- `opportunities/events/eagxindia-2026.md`
...
# 🧭 Moderator Review: EAGxIndia 2026
...
| Original issue | [Open submission](<https://github.com/elchrysaki/offmap-hub/issues/65>) |
| Proposed opportunity page | `opportunities/events/eagxindia-2026.md` |
...
- audience classification (no dropdown group selected)
- nationality/residency rules (not exclusive to Indian nationals, but focus is Indian EA community)
- Check for application link and deadline updates
- Clarify eligibility and funding details if more information becomes available
...
- [Source](<https://www.effectivealtruism.org/ea-global/events/eagxindia-2026?utm_source=ea-opps>)
...
Generated at 2026-07-20T09:05:33.144047+00:00.