...
# OffMap moderator review for issue #47
...
- **Issue:** [[Discovery]: EA Summit: Warsaw 2026](https://github.com/elchrysaki/offmap-hub/issues/47)
- **Submitted by:** `elchrysaki`
- **Processed at:** `2026-07-20T08:48:33.893070+00:00`
...
- `artifacts/raw-submission-47.json`
- `artifacts/researched-submission-47.json`
- `artifacts/publishable-content-47.json`
- `artifacts/review-report-47.md`
- `opportunities/events/ea-summit-warsaw-2026.md`
...
# 🧭 Moderator Review: EA Summit: Warsaw 2026
...
| Field | Value |
|---|---|
| Opportunity | EA Summit: Warsaw 2026 |
...
| Original issue | [Open submission](<https://github.com/elchrysaki/offmap-hub/issues/47>) |
| Proposed opportunity page | `opportunities/events/ea-summit-warsaw-2026.md` |
...
- host\_city
- host\_country
- current\_edition (confirmed with clarification)
- application\_deadline (confirmed with clarification)
- end\_date (confirmed with clarification)

## ⚠️ Possible Conflicts

- organizer (submitted as event name, official evidence shows Effective Altruism Global as organizer)
- Organizer field: submitted as event name, official evidence shows Effective Altruism Global as organizer.
...
- eligibility details
- audience groups
- No direct application link found.
- No explicit eligibility details.
- No funding or support information.
- No audience groups selected.

## 🔍 Requires Human Judgment

- audience classification (no dropdown group selected, but event is open to those interested in effective altruism/global challenges)
- Check for application link or process
- Clarify organizer field
- Clarify eligibility and funding details
- Audience classification requires moderator judgment; event is open to those interested in effective altruism/global challenges.

## 🚫 Claims Excluded From the Public Draft

- No claims about fees, scholarships, or travel support due to lack of evidence.
...
- [Source](<https://www.effectivealtruism.org/ea-global/events/ea-summit-warsaw-2026?utm_source=ea-opps>)
- [Source](<https://www.effectivealtruism.org/ea-global>)
...
Generated at 2026-07-20T08:48:31.473658+00:00.