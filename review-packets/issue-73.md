...
# OffMap moderator review for issue #73
...
- **Issue:** [[Discovery]: EA Global: New York City 2026](https://github.com/elchrysaki/offmap-hub/issues/73)
- **Submitted by:** `elchrysaki`
- **Processed at:** `2026-07-20T09:25:14.409455+00:00`
...
- `artifacts/raw-submission-73.json`
- `artifacts/researched-submission-73.json`
- `artifacts/publishable-content-73.json`
- `artifacts/review-report-73.md`
- `opportunities/events/ea-global-new-york-city-2026.md`
...
# 🧭 Moderator Review: EA Global: New York City 2026
...
| Field | Value |
|---|---|
| Opportunity | EA Global: New York City 2026 |
...
| Original issue | [Open submission](<https://github.com/elchrysaki/offmap-hub/issues/73>) |
| Proposed opportunity page | `opportunities/events/ea-global-new-york-city-2026.md` |
...
- language requirements (likely English, not explicit)
- audience group (none selected, none confirmed)
- Check for funding/support details if available elsewhere.
- Clarify if any specific audience group should be tagged.
...
- [Source](<https://www.effectivealtruism.org/ea-global/events/ea-global-new-york-city-2026>)
...
Generated at 2026-07-20T09:25:12.284288+00:00.