...
# OffMap moderator review for issue #35
...
- **Issue:** [[Discovery]: NASA's Lucy Mission LEAP Internship](https://github.com/elchrysaki/offmap-hub/issues/35)
- **Submitted by:** `elchrysaki`
- **Processed at:** `2026-07-20T07:22:38.285586+00:00`
...
- `artifacts/raw-submission-35.json`
- `artifacts/researched-submission-35.json`
- `artifacts/publishable-content-35.json`
- `artifacts/review-report-35.md`
- `opportunities/internships/nasa-s-lucy-mission-leap-internship.md`
...
# 🧭 Moderator Review: NASA's Lucy Mission LEAP Internship
...
| Field | Value |
|---|---|
| Opportunity | NASA's Lucy Mission LEAP Internship |
| Main category | `internships` |
| Specific category | `internship` |
...
| Original issue | [Open submission](<https://github.com/elchrysaki/offmap-hub/issues/35>) |
| Proposed opportunity page | `opportunities/internships/nasa-s-lucy-mission-leap-internship.md` |
...
- eligibility details
- Check for eligibility restrictions (nationality, academic level, etc.)
- Clarify if any funding or compensation is provided
- Confirm if there is a direct application link
...
- [Source](<https://www.lspace.asu.edu/mentor-internship>)
- [Source](<https://www.lspace.asu.edu/our-programs>)
- [Source](<https://www.lspace.asu.edu/lucy-internship>)
...
Generated at 2026-07-20T07:22:36.010595+00:00.